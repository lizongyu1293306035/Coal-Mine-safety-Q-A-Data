...
@Description: 处理源数据, 使用deepseek-v3(qwen平台的)
@Author: Li Zongyu
...
with open("../apikey/qwen.txt", "r", encoding="utf-8") as fp:
    apikey = fp.read()
client = OpenAI(api_key=apikey,
                base_url="https://dashscope.aliyuncs.com/compatible-mode/v1")
output_file_path = "processing_data/CoalQA_data15.json"
raw_data_file_name = "15-中华人民共和国煤炭法.txt"
